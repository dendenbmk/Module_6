...
a1.alive = True  # Создали атрибут  alive для ОБЪЕКТА a1 (ТУТ, а Не в классе и НЕ в родительском Классе) и указали, что True - 'живой' при создании
a1.fed = False   # Создали атрибут  fed  для ОБЪЕКТА a1 (ТУТ, а Не в классе и НЕ в родительском Классе) и указали, что False -  "голодный", не накормленный
a2.alive = True  # Создали атрибут  alive для ОБЪЕКТА a2 (ТУТ, а Не в классе и НЕ в родительском Классе) и указали, что True - 'живой' при создани
a2.fed = False   # Создали атрибут  fed  для ОБЪЕКТА a2 (ТУТ, а Не в классе и НЕ в родительском Классе) и указали, что False -  "голодный", не накормленный
...
print(a1.alive)               # выводим на печать атрибут .alive для хищника а1. (проверяя) живой True или нет False
print(a2.fed) # выводим на печать  атрибут .fed для млекопитающего а2.  (проверяя) накормленный  True или голодный Fa
